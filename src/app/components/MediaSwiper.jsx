        ...
        <div className="relative w-full h-full">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center text-white p-6">
            ...
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              className="px-8 py-4 bg-white text-gray-900 rounded-2xl font-bold 
          ...
          <motion.div
            ...
            className="absolute top-4 right-4 px-3 py-1.5 rounded-full bg-white/20 backdrop-blur-sm
      ...
      <div className="relative w-full h-full group">
        ...
        <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
          <motion.button
            ...
            whileTap={{ scale: 0.9 }}
            onClick={handleVideoClick}
            className="w-16 h-16 rounded-full bg-white/20 backdrop-blur-sm border border-white/30 
        ...
        <motion.div
          initial={{ opacity: 0, scale: 0.8 }}
          animate={{ opacity: 1, scale: 1 }}
          className="absolute top-4 right-4 px-3 py-1.5 rounded-full bg-[#F47A1F]/80 backdrop-blur-sm
                     flex items-center gap-2 text-white text-sm font-medium"
        >
          <Video className="w-4 h-4" />
          فيديو
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.9 }}
          onClick={toggleMute}
          className="absolute bottom-4 right-4 w-10 h-10 rounded-full bg-black/40 backdrop-blur-sm
  ...
  return (
    <div className="relative w-full h-full">
      ...
      <motion.div
        initial={{ opacity: 0, scale: 0.8 }}
        animate={{ opacity: 1, scale: 1 }}
        className="absolute top-4 right-4 px-3 py-1.5 rounded-full bg-[#1B2A4A]/80 backdrop-blur-sm
                   flex items-center gap-2 text-white text-sm font-medium border border-[#F47A1F]/30"
      >
...
const MediaSwiper = ({ 
  ...
  // استخدام البيانات الاستاتيكية
  useEffect(() => {
    if (customMedia) {
      setGallery({ media: customMedia, autoPlay: autoPlayDefault, autoPlayInterval: intervalDefault });
    }
    setIsLoading(false);
      ...
      <div className={`${height} ${className} flex items-center justify-center 
        ...
        >
          ...
          >
            ...
            <Sparkles className="absolute inset-0 m-auto w-6 h-6 text-[#F47A1F]" />
          </motion.div>
          <p className="text-[#B6BDD6]">جاري تحميل المعرض...</p>
        </motion.div>
      </div>
    );
  }
    ...
    <div className={`${className}`}>
      ...
      {gallery?.description && (
        <div className="text-center mb-6">
          <p className="inline-block text-orange-500 font-bold tracking-widest uppercase text-xl mb-3 px-4 py-1.5 rounded-full bg-orange-500/10 border border-orange-500/20">
            {gallery.description}
          </p>
        </div>
      )}
      ...
      <motion.button
        ...
        className="absolute left-4 top-1/2 -translate-y-1/2 z-20
                   ...
                   text-white hover:bg-[#F47A1F]/60 transition-all duration-300"
      >
